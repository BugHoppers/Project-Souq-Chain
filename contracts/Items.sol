...
contract Items {
    ...
    function createHaveRequest(string memory _seller, string memory _name_of_item, int  _quantity) public {
        raisedItemsCount ++;
        raisedItems[raisedItemsCount] = RaiseItem(raisedItemsCount, false, _seller, "", _name_of_item, _quantity);
    }
    ...
    function createNeedRequest(string memory _buyer, string memory _name_of_item, int _quantity) public {
        raisedItemsCount ++;
        raisedItems[raisedItemsCount] = RaiseItem(raisedItemsCount, false,"", _buyer, _name_of_item, _quantity);
    }
